...
export default function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-x-hidden">
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden w-full">
        <video
          src="/hero.mp4"
          autoPlay
          loop
      ...
      {/* Products Section */}
      <section id="products" ref={productsRef} className="fade-section transition-all duration-1000">
        <Products />
      </section>
      {/* About Section */}
      <section id="about" ref={aboutRef} className="fade-section transition-all duration-1000">
        <About />
      </section>
      {/* Contact Section */}
      <section id="contact" ref={contactRef} className="fade-section transition-all duration-1000">
        <Contact />
      </section>
      <style jsx global>{`
        .fade-section {
