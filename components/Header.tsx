...
export default function Header() {
  ...
  return (
    <header className="fixed top-6 left-1/2 z-50 -translate-x-1/2 flex justify-center w-full pointer-events-none">
      <div className="flex items-center justify-between gap-10 px-10 py-2 bg-white/30 backdrop-blur-lg rounded-full shadow-lg pointer-events-auto min-w-[420px] max-w-4xl w-full">
        {/* Logo */}
        ...
        <nav className="flex-1 flex justify-center gap-10">
          ...
          <Link href="/about" className="hover:text-primary font-semibold transition">About Us</Link>
